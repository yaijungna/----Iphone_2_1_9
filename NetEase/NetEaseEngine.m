...
-(void)xxxx:(NSData*)aData
{
	...
	[allParameters setObject:oauth_consumer_key forKey:OAuthConsumerKeyKey];
	[allParameters setObject:self.accessTokenKey forKey:OAuthTokenKey];
	//[allParameters setObject:@"xxxxx" forKey:NETEASE_CONTENT_STATUS];
	...
	NSString *queryString = [[NSString alloc] initWithFormat:NETEASE_PUBLISH_IMAGEFILE,
							 self.appKey,
							 oauth_nonce,
							 oauth_timestamp,
							 self.accessTokenKey,
