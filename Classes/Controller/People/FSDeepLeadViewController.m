    ...
    if ([sender isEqual:_fs_GZF_DeepLeadDAO]) {
        if (status == FSBaseDAOCallBack_BufferSuccessfulStatus || status == FSBaseDAOCallBack_SuccessfulStatus) {
            if ([_fs_GZF_DeepLeadDAO.objectList count]>0) {
                ...
                [tempDict setValue:((FSDeepLeadObject *)[_fs_GZF_DeepLeadDAO.objectList objectAtIndex:0]).share_img forKey:@"share_img"];
                [tempDict setValue:((FSDeepLeadObject *)[_fs_GZF_DeepLeadDAO.objectList objectAtIndex:0]).share_url forKey:@"share_url"];
                [tempDict setValue:((FSDeepLeadObject *)[_fs_GZF_DeepLeadDAO.objectList objectAtIndex:0]).share_text forKey:@"share_text"];
