...
-(void)postShareMessage{
    ...
    if (!_isLogin) {
        ...
        _fs_GZF_PeopleBlogSharePOSTXMLDAO.imagedata = self.dataContent;
        ...
        if (status == FSBaseDAOCallBack_SuccessfulStatus) {
           ...
           // [dict release];
            ...
            [self performSelector:@selector(returnToParentView) withObject:nil afterDelay:0.0];
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:SHARE_SUCCESSFUL_NOTICE object:self userInfo:dict];
                [dict release];
            }
