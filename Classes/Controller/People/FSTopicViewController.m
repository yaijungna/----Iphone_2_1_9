...
- (void)dealloc {
    ...
    _fs_GZF_DeepListDAO.parentDelegate = nil;
...
- (void)ownerPicture {
    ...
    if (ISIPHONE5) {
        _scrollPageView.frame = CGRectMake(FSLEFT_RIGHT_SPACE, 25.0f + 44 , self.view.frame.size.width - FSLEFT_RIGHT_SPACE * 2.0f , (self.view.frame.size.width - FSLEFT_RIGHT_SPACE * 2.0f)/2*3-18);
    }
    else{
        _scrollPageView.frame = CGRectMake(FSLEFT_RIGHT_SPACE, 10.0f + 44, self.view.frame.size.width - FSLEFT_RIGHT_SPACE * 2.0f , (self.view.frame.size.width - FSLEFT_RIGHT_SPACE * 2.0f)/2*3-18);
    }
    ...
    _myDeepListView.tag   = 1000;
//    _deepFloattingTitleView = [[FSDeepFloatingTitleView alloc] init];
//    _deepFloattingTitleView.tag = 2000;
//    _deepFloattingTitleView.frame= CGRectMake(FSLEFT_RIGHT_SPACE+12, 18.0f + _scrollPageView.frame.size.height, self.view.frame.size.width - FSLEFT_RIGHT_SPACE * 2.0f -24,self.view.frame.size.height- 18.0f - _scrollPageView.frame.size.height);
    ...
    if (ISIPHONE5) {
        _deepFloattingTitleView = [[FSDeepFloatingTitleView alloc] initWithFrame:CGRectMake(FSLEFT_RIGHT_SPACE+12, 18.0f + _scrollPageView.frame.size.height, self.view.frame.size.width - FSLEFT_RIGHT_SPACE * 2.0f -24,self.view.frame.size.height- 18.0f - _scrollPageView.frame.size.height)];
...
-(void)changeStyleOfDeepList
{
    ...
    }else
    {
        ...
        [self.view addSubview:_scrollPageView];
        [self.view addSubview:_deepFloattingTitleView];
        [self.view bringSubviewToFront:_deepFloattingTitleView];
    }
...
//    self.view                            = nil;
    self.isListStyle                     = YES;
    self.fs_GZF_DeepListDAO.parentDelegate = nil;
    self.fs_GZF_DeepListDAO              = nil;
