    ...
    if ([sender isEqual:_fs_GZF_DeepOuterLinkListDAO]) {
        ...
        if (status == FSBaseDAOCallBack_BufferSuccessfulStatus || status == FSBaseDAOCallBack_SuccessfulStatus) {
            ...
            if ([_fs_GZF_DeepOuterLinkDAO.objectList count]>0) {
                ...
                [tempDict setValue:_deepOuterView.outerObject.share_img forKey:@"share_img"];
                [tempDict setValue:_deepOuterView.outerObject.share_url forKey:@"share_url"];
                [tempDict setValue:_deepOuterView.outerObject.share_text forKey:@"share_text"];
