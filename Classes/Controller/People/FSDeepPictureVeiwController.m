        ...
        if (status == FSBaseDAOCallBack_BufferSuccessfulStatus || status == FSBaseDAOCallBack_SuccessfulStatus) {
            ...
            if([_fs_GZF_DeepPictureDAO.objectList count]>0){
                ...
                if (status == FSBaseDAOCallBack_SuccessfulStatus) {
                    ...
                    [tempDict setValue:((FSDeepPictureObject *)[_fs_GZF_DeepPictureDAO.objectList objectAtIndex:0]).share_img forKey:@"share_img"];
                    [tempDict setValue:((FSDeepPictureObject *)[_fs_GZF_DeepPictureDAO.objectList objectAtIndex:0]).share_url forKey:@"share_url"];
                    [tempDict setValue:((FSDeepPictureObject *)[_fs_GZF_DeepPictureDAO.objectList objectAtIndex:0]).share_text forKey:@"share_text"];
