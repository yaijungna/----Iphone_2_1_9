...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict {
	...
	if ([_currentElementName isEqualToString:fs_weather]) {
        ...
        if (parser.delegate) {
            self.obj = (FSWeatherObject *)[self insertNewObjectTomanagedObjectContext];
        }
        if (parser.delegate) {
    ...
    if ([_currentElementName isEqualToString:fs_index]) {
        self.Uobj = (FSUserSelectObject *)[self insertNewObjectTomanagedObjectContextN:@"FSUserSelectObject"];
