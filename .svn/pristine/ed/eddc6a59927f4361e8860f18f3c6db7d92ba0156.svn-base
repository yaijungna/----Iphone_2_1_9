...
@protocol TCWBRequestDelegate <NSObject>
...
@interface TCWBRequest : NSObject{
    ...
    id<TCWBRequestDelegate>   delegate;
    BOOL                    complete;
...
@property (nonatomic, assign) TCWBRequestPostDataType postDataType;
@property (nonatomic, retain) NSDictionary *httpHeaderFields;
@property (nonatomic, assign) id<TCWBRequestDelegate> delegate;
